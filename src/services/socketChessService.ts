...
// Server URL from environment variable - use the Render.com WebSocket URL
const SOCKET_SERVER_URL = import.meta.env.VITE_SOCKET_CHESS_SERVER_URL || 'wss://socket-chess-server.onrender.com';
